...
export function renderMotivation(container,state,app){
  ...
  container.innerHTML=`
    ...
    <article class="card hero"><div class="eyebrow">ช่วงที่ยากที่สุด</div><blockquote style="font-size:23px;line-height:1.45;margin:12px 0 0;font-weight:750">“${escapeHtml(motivation||'ฉันเลือกมาที่นี่เพื่อจบอย่างสุขภาพดี มีความสุข และกลับบ้านได้ด้วยร่างกายที่ยังรักการวิ่ง')}”</blockquote></article>
